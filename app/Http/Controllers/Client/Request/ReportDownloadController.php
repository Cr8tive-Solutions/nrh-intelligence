...
class ReportDownloadController extends Controller
{
    public function download(ScreeningRequest $request, ReportVersion $version): BinaryFileResponse|StreamedResponse
    {
        ...
        // Report PDFs are generated by the admin portal onto its private disk,
        // reachable here via the admin_local mount (see config/filesystems.php).
        $disk = Storage::disk('admin_local');
