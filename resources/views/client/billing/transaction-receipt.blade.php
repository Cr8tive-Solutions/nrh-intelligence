<x-client.layouts.app pageTitle="Receipt {{ $transaction->reference ?? $transaction->id }}">
    ...
    <div style="display:flex;align-items:center;gap:8px;font-size:13px;color:var(--ink-500);margin-bottom:24px;">
        <a href="{{ route('client.billing.transactions') }}" style="color:var(--ink-500);text-decoration:none;" onmouseover="this.style.color='var(--emerald-700)'" onmouseout="this.style.color='var(--ink-500)'">Transactions</a>
        ...
        <span style="color:var(--ink-900);font-weight:600;font-family:var(--font-mono);">{{ $transaction->reference ?? 'TXN-' . $transaction->id }}</span>
    </div>
        ...
        <div class="nrh-card" style="overflow:hidden;">
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;padding:16px 32px;">
                ...
                <div style="display:flex;gap:8px;">
                    <button onclick="window.print()" class="btn-ghost" style="font-size:12px;">
                    ...
                    <a href="{{ route('client.billing.transactions') }}" class="btn-ghost" style="font-size:12px;">
